      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="rounded-3xl border border-secondary bg-card p-8 shadow-sm space-y-6">
          ...
          <div className="space-y-5">
            <Paragraph>
              Доставка осуществляется в рабочее время через курьеров Яндекса или Такси Максим, с зонами доставки Вы можете ознакомиться на{" "}
              <a
                href="#map"
            ...
            <Paragraph>
              Минимальная сумма заказа для <span className="text-green-600 font-medium">зеленой зоны</span> - 1500 рублей, стоимость доставки 250 рублей, бесплатная доставка для заказов от 3000 рублей.
            </Paragraph>
            <Paragraph>
              Минимальная сумма заказа для <span className="text-amber-500 font-medium">жёлтой зоны</span> - 2000 рублей, стоимость доставки 300 рублей, бесплатная доставка для заказов от 4000 рублей.
            </Paragraph>
            <Paragraph>
              Минимальная сумма заказа для <span className="text-rose-500 font-medium">красной зоны</span> - 3000 рублей, стоимость доставки 350 рублей, бесплатная доставка для заказов от 5000 рублей.
            </Paragraph>
          </div>
        </div>
